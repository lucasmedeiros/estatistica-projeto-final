...
Agora, objetivando encontrar o melhor modelo no qual as variáveis impactam na inferência da sobrevivência de um passageiro do Titanic, podemos selecionar utilizando diferentes tipos de abordagens, por exemplo, **Backward Elimination**, **Forward Elimination** e **Stewise**.
