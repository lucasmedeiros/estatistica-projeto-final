...
```{r}
AA=xyTable(data$Survived, data$Parch)

coeff_bigger=0.03

plot(AA$x , AA$y , cex=AA$number*coeff_bigger  , pch=19 , col=rgb(0,1,0,0.5) , xlab= "Survived" , ylab="Nº de pais/filhos" , xlim=c(0,1) , ylim=c(0,6))
text (AA$x , AA$y , AA$number)
