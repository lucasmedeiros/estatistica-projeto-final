...
## 3.5 Correlações das variáveis selecionadas
...
## 3.6 Análise das correlações das variáveis selecionadas

```{r, warning=FALSE}
#titanic_clean_data <- data %>% select('Survived', 'Pclass', 'Sex', 'Fare')
#titanic_clean_data %>%
#  ggcorr(palette = "RdBu",
#         color = "grey50",
#         label = TRUE, hjust = 1,
...
## 3.7 Comportamento dos dados em relação à sobrevivência
