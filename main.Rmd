...
```{r warning=FALSE}
  ggplot(gather(data.survivors %>% dplyr::select(-c("Fare", "Age", "Survived"))), aes(value)) + 
...
```{r, echo=FALSE, warning=FALSE}
  ggplot(gather(data.deads %>% dplyr::select(-c("Fare", "Age", "Survived"))), aes(value)) + 
  geom_histogram(stat="count") + 
  labs(x = "", y = "") +
  facet_wrap(~key, scales = 'free_x')
```
...
coeff_bigger=0.05
plot(AA$x , AA$y , cex=AA$number*coeff_bigger  , pch=16 , col=rgb(0,0,1,0.5) , xlab= "Survived" , ylab="Pclass" , xlim=c(0,1) , ylim=c(0,6) )
...
represent_discrete_variable=function(var1, var2 , coeff_bigger){
  ...
  plot(AA$x , AA$y , cex=AA$number*coeff_bigger  , pch=16 , col="chocolate1" , xlab= "Survived" , ylab="Pclass" )
  text (AA$x , AA$y , AA$number )
}
```
...
```{r}
AA=xyTable(data$Survived, data$Sex)

coeff_bigger=0.04
plot(AA$x , AA$y , cex=AA$number*coeff_bigger  , pch=16 , col=rgb(0,0,1,0.5) , xlab= "Survived" , ylab="Sexo" , xlim=c(0,1) , ylim=c(0,3) )
text (AA$x , AA$y , AA$number )
...
```{r}
AA=xyTable(data$Survived, data$SibSp)

coeff_bigger=0.03
plot(AA$x , AA$y , cex=AA$number*coeff_bigger  , pch=16 , col=rgb(0,0,1,0.5) , xlab= "Survived" , ylab="número de irmãos/cônjuges do passageiro abordo" , xlim=c(0,1) , ylim=c(0,6))
text (AA$x , AA$y , AA$number )
```
...
```{r}
AA=xyTable(data$Survived, data$Fare)

coeff_bigger=0.4

plot(AA$x , AA$y , cex=AA$number*coeff_bigger  , pch=19 , col=rgb(0,1,0,0.5) , xlab= "Survived" , ylab="Tarifa paga" , xlim=c(0,1) , ylim=c(0,100))
