...
Como podemos observar, a partir do método *stepwise*, percebemos que a seleção do modelo ideal para representação dos dados foi o que contém **PeD** e **Marketing**.

**Conclusão**: pela abordagem da **Stepwise**, chegamos a um modelo ideal com as variáveis **PeD** e **Marketing**, diferente do obtido na **Backward Elimination** e na **Forward Elimination**.